...
axs[0, 0].hist(all_x, bins=n_bins)
axs[0, 1].hist(all_w, bins=n_bins)
axs[1, 0].hist(all_x_rot_hard, bins=n_bins)
axs[1, 1].hist(all_w_rot_hard, bins=n_bins)
axs[2, 0].hist(all_x_rot_rand, bins=n_bins)
axs[2, 1].hist(all_w_rot_rand, bins=n_bins)
axs[3, 0].hist(all_x_rot_rand_transp, bins=n_bins)
axs[3, 1].hist(all_w_rot_rand_transp, bins=n_bins)

fig.suptitle("Unquantized Value Distributions")
axs[0, 0].set_title("Basic X")
axs[0, 1].set_title("Basic W")
axs[1, 0].set_title("True Hadamard X")
axs[1, 1].set_title("True Hadamard W")
axs[2, 0].set_title("Randomized Hadamard/True Inverse X")
axs[2, 1].set_title("Randomized Hadamard/True Inverse W")
axs[3, 0].set_title("Randomized Hadamard/Transpose Inverse X")
axs[3, 1].set_title("Randomized Hadamard/Transpose Inverse W")

fig2, axs2 = plt.subplots(4, 2, sharey=True, tight_layout=True)

axs2[0, 0].hist(int_128_vals, weights=x_distr_basic, bins=n_bins)
axs2[0, 1].hist(int_128_vals, weights=w_distr_basic, bins=n_bins)
axs2[1, 0].hist(int_128_vals, weights=x_distr_rot_hard, bins=n_bins)
axs2[1, 1].hist(int_128_vals, weights=w_distr_rot_hard, bins=n_bins)
axs2[2, 0].hist(int_128_vals, weights=x_distr_rot_rand, bins=n_bins)
axs2[2, 1].hist(int_128_vals, weights=w_distr_rot_rand, bins=n_bins)
axs2[3, 0].hist(int_128_vals, weights=x_distr_rot_rand_transp, bins=n_bins)
axs2[3, 1].hist(int_128_vals, weights=w_distr_rot_rand_transp, bins=n_bins)

fig2.suptitle("Quantized Value Distributions")
axs2[0, 0].set_title("Basic X")
axs2[0, 1].set_title("Basic W")
axs2[1, 0].set_title("True Hadamard X")
axs2[1, 1].set_title("True Hadamard W")
axs2[2, 0].set_title("Randomized Hadamard/True Inverse X")
axs2[2, 1].set_title("Randomized Hadamard/True Inverse W")
axs2[3, 0].set_title("Randomized Hadamard/Transpose Inverse X")
axs2[3, 1].set_title("Randomized Hadamard/Transpose Inverse W")
