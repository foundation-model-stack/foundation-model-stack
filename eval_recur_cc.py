...
test.load_state_dict(torch.load("/lustre/dwertheimer/results/llama-speculator/gen3/recur-n2-gen-smalllr-short_PAhsdp_ws8_mbs32_sl64_pr0_vFMS82186057_jid2764_sysAwsEfa0/checkpoints/step_15000_ckp.pth", map_location="cpu")["model_state"])
test.cuda()
