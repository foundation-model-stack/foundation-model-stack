...
def test_instructions_dataset():
    ...
    with tempfile.NamedTemporaryFile(mode='w+t') as file:
        ...
        file.seek(0)
        instructions = JsonInstructions(file.name, tokenizer, bos_tok_id=1, eos_tok_id=2)
...
def test_text_dataset():
    ...
    torch.testing.assert_close(first_input, torch.tensor(tokenizer.convert_tokens_to_ids(['a'] * 99)))
