...
def _get_hf_model_output(model_path, inputs, position_ids):
...
def _get_fms_model_output(model_path, inputs, **kwargs):
    model = get_model(
...
def test_mpnet_v2_equivalence():
    ...
    hf_model_output = _get_hf_model_output(model_path, 
                      inputs_hf, position_ids_hf)
    fms_model_output = _get_fms_model_output(model_path, 
