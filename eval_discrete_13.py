...
#             print(decode_obo(input_ids[i]))
        ...
        mask = torch.ones(input_ids.size(1),input_ids.size(1)+n_kv_s[0][0].size(2), device=input_ids.device, dtype=torch.bfloat16)
...
test.load_state_dict(torch.load("/lustre/dwertheimer/results/llama-speculator/gen4/discrete-n2-gen_PAhsdp_ws16_mbs96_sl64_pr0_vFMSbfcc2ff_jid3360_sysAwsEfa0/checkpoints/step_6000_ckp.pth", map_location="cpu")["model_state"])
test.cuda()
...
torch.save(steps, "/lustre/dwertheimer/results/llama-speculator/gen4/discrete-n2-gen_PAhsdp_ws16_mbs96_sl64_pr0_vFMSbfcc2ff_jid3360_sysAwsEfa0/steps_for_100_at_k.pth")
# torch.save(outs, "/lustre/dwertheimer/results/sandbox/llama_13bf_sap_outputs.pth")