...
class Speculator(nn.Module):
    ...
    def generate_tree(self, state, ind, topk=[5, 4, 3], n=5):
        return self.generate_suffixes(state, ind, topk, n)
    ...
    def forward(self, state, inds):
        ...
        Inds requires self.n_heads-1 extra tokens on the right to "simulate" recursive behavior for end positions.
        """
        # state: b n d
