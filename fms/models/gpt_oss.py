...
def _hf_to_fms_names(input_sd: Mapping[str, Any], **kwargs) -> Mapping[str, Any]:
    ...
    replacements = [
        ...
        (r"mlp\.experts\.gate_up_proj_bias", "ff_sub_layer.cond_ffn.w1"),
        (r"mlp\.experts\.gate_up_proj_blocks", "ff_sub_layer.cond_ffn.w2"),
        (r"mlp\.experts\.gate_up_proj_scales", "ff_sub_layer.cond_ffn.w3"),
