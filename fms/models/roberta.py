...
models.register_model(
    _architecture_name, "micro", _roberta_factory_factory(_micro_char_config), _micro_char_config
)
models.register_model(
...
def _hf_sd_to_fms_sd(hf_sd: Mapping[Any, Any], config: RoBERTaConfig) -> Mapping[Any, Any]:
    replacements = [
